...
const MongoClient = require('mongodb').MongoClient//mongo client enables us to be able to use mongodb by using special methods
...
require('dotenv').config()//alows us access to the contentof the dotenv file
...
//connection returns a promise if the connection is successful while passing in client info
    .then(client => {
        //log a message to the console to  confirm the connection worked
        console.log(`Connected to ${dbName} Database`)
        //assigning value to db variable that contains db factory method
        db = client.db(dbName)
    })
//set up middleware
